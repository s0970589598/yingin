		...
		if($rowindex>=0){
			...
			for($i=0;$i<sizeof($text);$i++){
				...
				if($text[$i]=="")
		    		...
		    		$n[$key] = $text[1];
					$w[$key] = $text[2];
				    //$sqla62 = "INSERT INTO `kangxi`(`uncodechart`,`word`,`num`) VALUES('$u[$key]','$w[$key]','$n[$key]')";
				    ...
				    $sqla62 = "INSERT INTO `kangxi`(`uncodechart`,`word`,`num`) VALUES('$u[$key]','$w[$key]','$[$key]')";
					mysqli_query($database_link,$sqla62);
